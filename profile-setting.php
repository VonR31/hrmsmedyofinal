              ...
              <div class="row">
                ...
                <div class="col-xl-6 col-sm-12 col-12 d-flex">
                  <div class="card flex-fill">
                    <div class="card-header">
                      <h2 class="card-titles">
                        Company Notification Settings<span
                    ...
                    <div class="card-body">
                          ...
                          <li>
                            <div class="company-path checkworking">
                              ...
                              <label for="che2"
                                ...
                                <span
                                  >A weekly email containing all changes related
                                  to your payroll..</span
                                >
                              </label>
                            </div>
                          </li>
                      ...
                      <div class="btn-set pl-0">
                        <a class="btn btn-apply"
                          >Update Notification Settings</a
                        >
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-xl-12 col-sm-12 col-12">
                  <div class="card">
                    <div class="card-header">
                      <h2 class="card-titles">
                        Team Member Notification Settings<span
                          >You will receive notifications only for Team
                          Leads.</span
                        >
                      </h2>
                    </div>
                            ...
                            <div class="company-path checkworking">
                              ...
                              <label for="che6"
                                ...
                                <span
                                  ...
                                  day before a team member’s birthday.</span
                                >
                              </label>
                            </div>
                          </li>
                            ...
                            <div class="company-path checkworking">
                              ...
                              <label for="che7"
                                ...
                                <span
                                  ...
                                  the week and the day before.</span
                                >
                              </label>
                            </div>
                          </li>
                            ...
                            <div class="company-path checkworking">
                              ...
                              <label for="che4"
                                ...
                                <span
                                  ...
                                  date set and reminds you the day before.</span
                                >
                              </label>
                            </div>
                          </li>
